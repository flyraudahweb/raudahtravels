...
if (process.env.NODE_ENV === "production") {
  ...
  const frontendCSP = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.raudahtravels.com https://*.clerk.accounts.dev https://*.clerk.dev https://challenges.cloudflare.com https://js.paystack.co https://static.cloudflareinsights.com",
